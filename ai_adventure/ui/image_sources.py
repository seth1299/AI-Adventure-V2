...
class NewGameImageSourceDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        create_image: Callable[[VisualAssetRequest], tuple[bool, str]],
        ...
        self._rows: dict[str, tuple[QLabel, QPushButton, QPushButton, QPushButton]] = {}
        ...
        explanation = QLabel(
            "Choose a local image, ask Gemini to create one using the existing image "
            "prompt, or skip a subject for now. Nothing is generated until you press "
    ...
    def _build_request_row(self, request: VisualAssetRequest) -> QWidget:
        ...
        generate_button = QPushButton("Create an Image for me")
        ...
        generate_button.clicked.connect(
            lambda _checked=False, asset_request=request: self._create_image(asset_request)
        )
        skip_button.clicked.connect(
            lambda _checked=False, asset_request=request: self._skip(asset_request)
        )

        buttons = _button_row(upload_button, generate_button, skip_button)
